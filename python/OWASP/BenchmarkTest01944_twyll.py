...
#Original file name: OWASP/BenchmarkTest01944.py
#Original file CWE's: [78]  
#Original file kind: fail
#Mutation info: Insert template from /home/stepanov/f/psi-fuzz/templates-db/languages/python/sensitivity/collections/comprehension.tmt with name nested_list_comprehension_negative 
#Used extensions: 
#Program:
from Record import *
