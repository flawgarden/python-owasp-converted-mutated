...
#Mutation info: Insert template from /home/stepanov/f/psi-fuzz/templates-db/languages/python/sensitivity/collections/set.tmt with name set_remove_positive 
#Used extensions: EXPR_Any -> ImplementingSuperSideClass()
#Program:
from Record import *
