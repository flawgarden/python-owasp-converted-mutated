...
#Mutation info: Insert template from /home/stepanov/f/psi-fuzz/templates-db/languages/python/sensitivity/conditional/recursion.tmt with name recursion_mutual_negative 
#Used extensions: 
#Program:
from Record import *
...
def benchmark_post():
    ...
    values = param_or_empty_mutual2(len(values), values[0])
