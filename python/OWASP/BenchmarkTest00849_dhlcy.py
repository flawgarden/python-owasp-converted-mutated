...
#Original file name: OWASP/BenchmarkTest00849.py
#Original file CWE's: [89]  
#Original file kind: fail
#Mutation info: Insert template from /home/stepanov/f/psi-fuzz/templates-db/languages/python/sensitivity/field/nested.tmt with name nested_field_depth_2_negative 
#Used extensions: 
#Program:
from Record import *
