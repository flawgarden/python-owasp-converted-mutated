...
#Mutation info: Insert template from /home/stepanov/f/psi-fuzz/templates-db/languages/python/sensitivity/collections/generators.tmt with name generator_simple_negative
#Used extensions:
#Program:
from Record import *
...
def do_something(param):
    ...
    gen = simple_generator(bar, "tjkwm", "avlli")
    genToList = list(gen)
    bar = genToList[1]
