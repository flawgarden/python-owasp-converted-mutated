...
#-------------
#Snyk analysis results: [643, 611, 79]
#Bearer analysis results: []
#CodeQL analysis results: [209, 497, 79, 116, 643]
...
#Used extensions: MACRO_Create_Set -> ~[MACRO_SetName]~ = set() | MACRO_Add_EXPR_ToSet -> ~[MACRO_SetName]~.add(~[EXPR_~[TYPE@1]~]~) | MACRO_Add_Fixed_VAR_ToSet -> ~[MACRO_SetName]~.add(~[VAR_~[TYPE@1]~@1]~) | MACRO_SetName -> set787231 | MACRO_SetName -> set787231 | MACRO_SetName -> set787231 | EXPR_str -> ~[EXPR_str]~.upper() | MACRO_SetName -> set787231
#Program:
from Record import *
