...
#Mutation info: Insert template from /home/stepanov/f/psi-fuzz/templates-db/languages/python/sensitivity/interpolation.tmt with name f_string_with_string_operations_positive
#Used extensions:
#Program:
from Record import *
