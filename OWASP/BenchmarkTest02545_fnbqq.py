...
#Mutation info: Insert template from /home/stepanov/f/psi-fuzz/templates-db/languages/python/sensitivity/duck/typing.tmt with name duck_typing_missing_method_exception_positive 
#Used extensions: 
#Program:
from Record import *
